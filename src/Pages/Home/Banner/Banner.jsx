    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center pl-7 h-full w-1/3 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] bottom-0">
                    <div className="text-white space-y-7">
                        ...
                        <div>
                            ...
                            <button className="btn btn-active btn-active">Latest Project</button>
                        </div>
                    </div>
                </div>
